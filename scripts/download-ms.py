...
DOWNLOAD_LINK = "http://www.tunerstudio.com/downloads2/TunerStudioMS_v3.1.04.tar.gz"
#DOWNLOAD_LINK = "https://www.efianalytics.com/TunerStudio/beta/TunerStudioMS_v3.1.04.07_Beta.tar.gz"
...
class SnapUIWindow(Gtk.Window):
    ...
    def __init__(self):
        Gtk.Window.__init__(self, title="Downloading TunerStudio")
        ...
        hb.props.title = "Downloading TunerStudio"
    ...
    def start_download(self):
        self.infolabel.set_text("Downloading TunerStudio")
    ...
    def download_thread(self):
        ...
        with open('TunerStudio-Last-Modified', 'w+') as f:
...
def requires_update():
    ...
    try:
        with open('TunerStudio-Last-Modified', 'r') as f:
